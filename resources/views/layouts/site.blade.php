                                ...
                                <div class="container-right-half">
                                    <div class="row">
                                        <div class="col-md-11 col-md-offset-1">
                                            ...
                                            <p id="requestsent" class="alert alert-success" style="display: none">Thank you! we will get back to you soon.</p>
                                                ...
                                                <div class="row columns_margin_bottom_30">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" aria-required="true" size="30" value="" name="first_name" id="first-name" class="form-control" placeholder="First Name" required="">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" aria-required="true" size="30" value="" name="last_name" id="last-name" class="form-control" placeholder="Last Name" required="">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="email" class="sr-only">Your E-Mail</label>
                                                            <input type="text" size="30" value="" name="email" id="email" class="form-control" placeholder="Your E-Mail" required="">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" aria-required="true" size="30" value="" name="phone" id="phone" class="form-control" placeholder="Your Phone" required="">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group select-group">
                                                            ...
                                                            <div class="input-group">
                                                                <select aria-required="true" id="month" name="practice_area" class="choice empty form-control" required="">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="1" cols="45" name="message" id="comment" class="form-control" placeholder="Your Message" required=""></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <p class="form-submit">
