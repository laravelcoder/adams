...
///////////////////////////
        ...
        if (isset($request->first_name)) {
            ...
            if (!empty($request->first_name))
                $sender_name = stripslashes(strip_tags(trim($request->first_name)));
            if (!empty($request->last_name))
                $sender_name .=' '. stripslashes(strip_tags(trim($request->last_name)));
            ...
            if (!empty($request->practice_area))
                $subject = stripslashes(strip_tags(trim($request->practice_area)));
